            ...
            <div className="container-custom mx-auto flex items-center justify-between px-4">
                ...
                <div className="flex items-center gap-6">
                    <Link href="/" className="flex items-center gap-2 no-underline group">
                        <div className="bg-primary-navy text-white px-2.5 py-1rounded-sm font-bold text-lg tracking-tight font-serif group-hover:bg-primary-blue transition-colors rounded">
                            HS
                        </div>
                ...
                <div className="flex items-center gap-3">
                    ...
                    <button className="text-xs font-semibold text-text-secondary hover:text-primary-navy px-2 py-1 transition-colors">
                        Oturum Aç
                    </button>
                    <button className="btn-tactile primary text-xs">
                        Hesap Oluştur
                    </button>
                </div>
            </div>
